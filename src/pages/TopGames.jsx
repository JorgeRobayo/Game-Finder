  ...
  return (
    <div className="topGmsMstrDiv">
        ...
        <section id="game2" className="topGamesReversed">
          ...
          <div className="gmDescription">
            <h3>
              ...
              while avoiding hazards such as enemies and pits with the aid of
            ...
            <h3>
              ...
              mechanics and programming, drawing from their experiences working
              on Devil World and the side-scrollers Excitebike and Kung Fu to
              advance their previous work on platforming "athletic games" such
              as Donkey Kong and Mario Bros. The design of the first level,
              World 1-1, serves as a tutorial for platform gameplay.
            </h3>
          </div>
        </section>
      </div>
      ...
      <div className="cntnrtRight">
        ...
        <section>
          <h3 id="game1Description2" className="gmDescription">
            A game that makes you feel good about punching a journalist while
            also making you feel bad for fancying a polygonal alien, Mass Effect
            was BioWare's big new punt at a not-Star Wars space opera IP about
            evil squids destroying the universe. It was great - but the series'
      ...
      <div className="cntnrReverse">
        <section id="game2" className="topGamesReversed">
          ...
          <div className="gmDescription">
            <h3>
              Fortnite is an online video game and game platform developed by
              Epic Games and released in 2017. It is available in six distinct
              game mode versions that otherwise share the same general gameplay
              and game engine: Fortnite Battle Royale, a free-to-play battle
              royale game in which up to 100 players fight to be the last person
              standing; Fortnite: Save the World, a cooperative hybrid tower
              defense-shooter and survival game in which up to four players
              fight off zombie-like creatures and defend objects with traps and
              fortifications they can build; and Fortnite Creative, in which
              players are given complete freedom to create worlds and battle
              arenas, Lego Fortnite, Rocket Racing and Fortnite Festival.
            </h3>

            <h3>
              A pop culture mash-up machine featuring everything from
              Christopher Nolan movie trailer debuts to Travis Scott concerts,
              Fortnite is the closest we've come to a real metaverse in 2023.
              For kids growing up nowadays, it's practically a rite of passage.
            </h3>
          </div>
        </section>
      </div>
      ...
      <div className="cntnrtRight">
        ...
        <section>
          <h3 id="game1Description2" className="gmDescription">
            There are entire childhoods with just one core memory: trying to get
            a 1080 in the halfpipe in the Hangar level for absolutely no reward
            bar your own sense of accomplishment. Wouldn't have it any other
            way.
          </h3>
        </section>
      </div>
