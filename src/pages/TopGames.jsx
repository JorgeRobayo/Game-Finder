    ...
    <div className="topGmsMstrDiv">
      ...
      <section>
        <h3 id="game1Description2" className="gmDescription">
          ...
          number of new features was praised, as were the gameplay improvements.
          The game received "universal acclaim" according to video game review
          aggregator Metacritic. Three months after its release, two million
          copies of Age of Empires II had been shipped, and it topped sales
          charts in seven countries. The game won multiple awards and is today
          considered a classic of its type, having had a significant impact on
          future games in its genre. The original Age of Empires II and its 2000
          expansion pack, The Conquerors, were later released as The Gold
          Edition. Age of Empires II is often considered one of the greatest
          games ever made.
        </h3>
      </section>
      ...
      <section id="game1" className="topGamesReversed">
        <div className="topGmImgDiv">
          <img
            className="topGmImg"
            src={
